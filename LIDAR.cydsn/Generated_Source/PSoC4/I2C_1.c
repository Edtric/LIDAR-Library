...
static void I2C_1_ScbModeStop(void)
{
    ...
    *******************************************************************************/
    void I2C_1_SetPins(uint32 mode, uint32 subMode, uint32 uartEnableMask)
    {
        ...
        {
            hsiomSel[I2C_1_RX_SCL_MOSI_PIN_INDEX] = I2C_1_HSIOM_I2C_SEL;
            hsiomSel[I2C_1_TX_SDA_MISO_PIN_INDEX] = I2C_1_HSIOM_I2C_SEL;
        ...
        {
            hsiomSel[I2C_1_RX_SCL_MOSI_PIN_INDEX] = I2C_1_HSIOM_SPI_SEL;
            hsiomSel[I2C_1_TX_SDA_MISO_PIN_INDEX] = I2C_1_HSIOM_SPI_SEL;
        ...
        else /* UART */
        {
            ...
            {
                /* SmartCard */
                hsiomSel[I2C_1_TX_SDA_MISO_PIN_INDEX] = I2C_1_HSIOM_UART_SEL;
                pinsDm  [I2C_1_TX_SDA_MISO_PIN_INDEX] = I2C_1_PIN_DM_OD_LO;
            }
            else /* Standard or IrDA */
            {
                ...
                {
                    hsiomSel[I2C_1_RX_SCL_MOSI_PIN_INDEX] = I2C_1_HSIOM_UART_SEL;
                    pinsDm  [I2C_1_RX_SCL_MOSI_PIN_INDEX] = I2C_1_PIN_DM_DIG_HIZ;
                }
    ...
    #if (I2C_1_SCLK_PIN)
        I2C_1_SET_HSIOM_SEL(I2C_1_SCLK_HSIOM_REG,
                                       I2C_1_SCLK_HSIOM_MASK,
                                       I2C_1_SCLK_HSIOM_POS,
                                       hsiomSel[I2C_1_SCLK_PIN_INDEX]);
    ...
    #if (I2C_1_SS0_PIN)
        I2C_1_SET_HSIOM_SEL(I2C_1_SS0_HSIOM_REG,
                                       I2C_1_SS0_HSIOM_MASK,
                                       I2C_1_SS0_HSIOM_POS,
                                       hsiomSel[I2C_1_SS0_PIN_INDEX]);
